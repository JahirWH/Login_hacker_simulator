 ...
 -->							
					...
					<section  class="modal_1" id="modal" >
						...
						<div class="container_modal" >
							...
							<li><a href="https://godofredo.ninja/mejores-temas-para-sublime-text-3-2/"><b>Import Styles from Sublime text3 ayu and Agila</b></a></li>
							...
							<li><a target="_blank" href="https://www.earthcam.com/"> cameras from eatr</a> </li>

							<li><a target="_blank" href="https://www.skylinewebcams.com/en/webcam.html">Sky cams online</a></li>
							...
							<li><a target="_blank" href="https://www.sololearn.com/Codes">Codes of Proyects Insterestings and goods free wacht</a></li>
							...
							<li><a target="_blank" href="https://www.youtube.com/embed/llufppyponk?rel=0&autoplay=1&controls=0&showinfo=0&loop=1&disablekb=1&showinfo=0&playlist=llufppyponk">same fake video may be</a></li>
							<li><a target="_blank" href="http://www.staggeringbeauty.com/"> gusano animado</a></li>
							<li><a href="https://inventwithpython.com/es/">Learns whit python</a></li>
							<li><a target="_blank" href="https://dev.to/afif/i-made-100-css-loaders-for-your-next-project-4eje">Loader CSS </a> </li>
							<li><a target="_blank" href="https://www.pngegg.com/es/png-btcty"> PNG free for proyects</a> </li>
							<li><a target="_blank" href="https://www.enterat.com/actualidad/estacion-espacial-directo.php"> estacion espacial</a> </li>
							<li><a target="_blank" href="https://www.baidu.com/">Search from china</a> </li>
							<li><a target="_blank" href="https://png.is/tool/findstock"> Dowloader from Stoock images</a> </li>
...
<!-- 						<img class="img_back" src="bg.gif">
 -->
						<div class="acess_div">
							<nav class="acess_nav"><span class="decor"></span><p class="title2">ACESS</p><button class="btn" onclick="acess()">X</button></nav>
							...
							<nav class="acess_nav2"><span class="decor2"></span> <button class="send" onclick="send(event)" >connect</button></nav>
						</div>
					</section>
					...
					<section class="negar" id="negado">
						<div class="negar_2">
							<div class="negar_3">
								<nav><div class="bt">X</div></nav>
								<img src="acess.png">
								<p class="textp">ACCESS DENIED!</p>
								<p class="ipi">Rejecute Port: <strong  > 8080</strong></p>
								<p class="ipi">IP ADDRESS :  <strong  id="ipId2"></strong></p>
							</div>
						</div>
					...
					<section class="intro" id="int">
						...
						<div class="border1"><img src="border.png"></div>
						<div class="border2"></div>
						<div class="border3"></div>
						<div class="border4"><img src="border.png"></div>
							<p class="textp2">ACCESS GRANTED!</p>
							<p class="ipi">Rejecute Port: <strong  > 8080</strong></p>
							<p class="ipi">IP ADDRESS :  <strong  id="ipId3"></strong></p>
						</div>
					</section>
					...
					<section class="sec" id="sec">
						<div class="holograms"><img src="2.gif">
							<img src="https://cdn.statcdn.com/Infographic/images/normal/16867.jpeg" alt="Infografía: El panorama de la corrupción en América Latina | Statista" width="100%" height="auto" style="width: 100%; height: auto !important; max-width:960px;-ms-interpolation-mode: bicubic; position: absolute;"/> 
					...
					<section class="cameras" id="show">
						...
						<div class="container_cameras" >
							<nav class="camera_nav"><img src="close.png"></nav>
							<nav class="nav2">

								<p id="as" class="title2"><b>Chanels</b>
								...
								<table class="table_1">
									<tbody class="table_2">
										<tr>
											<td><button class="btn_ta" onclick="showcam1()">Chanel 1 Snapshoot </button></td>
											<td><button class="btn_ta" onclick="showcam2()">Chanel 2 Snapshoot </button></td>
											<td><button class="btn_ta" onclick="showcam3()">Chanel 3 Snapshoot </button></td>
											<td><button class="btn_ta" onclick="showcam4()">Chanel 4 Snapshoot </button></td>
											<td><button class="btn_ta" onclick="showcam5()">Chanel 5 Snapshoot</button></td>
											<td><button class="btn_ta" onclick="showcam6()">Chanel 6 Snapshoot </button></td>
							...
							<div class="order1" >
								<img src="id.png" class="cameras_img "  id="back1"> 
			...
			<script type="text/javascript">
				const wrap = document.querySelector(".container_cameras"),
				hea = wrap.querySelector("nav");

				function onD({movementX, movementY}){
					let getSty = window.getComputedStyle(wrap);
					let leftV = parseInt(getSty.left);
					let topV = parseInt(getSty.top);
					wrap.style.left = `${leftV + movementX}px`;
					wrap.style.top = `${topV + movementY}px`;
				}
				hea.addEventListener("mousedown", ()=>{
					hea.classList.add("active");
					hea.addEventListener("mousemove", onD);
				});
				document.addEventListener("mouseup", ()=>{
					hea.classList.remove("active");
					hea.removeEventListener("mousemove", onD);
				});
